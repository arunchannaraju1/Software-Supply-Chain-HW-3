...
We actively support only the latest version of this project, available on the `main` branch. We ensure that security patches are applied promptly to this version.

| Version               | Supported          |
| --------------------- | ------------------ |
| Latest (Release 3.0)  | :white_check_mark: |
...
We appreciate your commitment to responsible disclosure, and we will acknowledge your contributions accordingly.
